# GitHub Release v2.6.3 创建指南

## ✅ 已完成步骤

1. ✅ Git tag `v2.6.3` 待创建
...
1. 打开浏览器，访问：
   ```
   https://github.com/MightyKartz/PLCN/releases/new?tag=v2.6.3
   ```
...
### 构建修复
- ✅ **修复 GitHub Actions 构建失败**：优化了 DAT 文件复制逻辑，解决了因部分目录可能为空导致的构建错误。
...
**完整更新日志**: https://github.com/MightyKartz/PLCN/compare/v2.6.2...v2.6.3
```
...
# 创建 release
gh release create v2.6.3 --title "v2.6.3 - 预览逻辑优化与构建修复" --notes-file release-notes.md
```
...
- 具体版本: https://github.com/MightyKartz/PLCN/releases/tag/v2.6.3
